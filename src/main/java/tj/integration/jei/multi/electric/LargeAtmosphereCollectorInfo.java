...
public class LargeAtmosphereCollectorInfo extends MultiblockInfoPage {
    ...
    public MultiblockShapeInfo getMatchingShapes(int extent) {
         return TJMultiblockShapeInfo.builder(LEFT, FRONT, DOWN)
                ...
                .where('F', ChannelRegistry.OUTPUT_HATCH, MetaTileEntities.FLUID_EXPORT_HATCH[0], EnumFacing.NORTH)
                .where('f', ChannelRegistry.INPUT_HATCH,MetaTileEntities.FLUID_IMPORT_HATCH[0], EnumFacing.UP)
                .where('o', ChannelRegistry.OUTPUT_HATCH ,MetaTileEntities.FLUID_EXPORT_HATCH[0], EnumFacing.DOWN)
                .build();
    }
